# Sovereign Artist Creative Studio � Immersive Portal Rebuild

**Phase:** PLAN
**Origin:** NAVD ideation session (Issue #113) + live site audit
**Replaces:** justin-aharoni-photography.vercel.app + justinaharoni.com (SquareSpace)
**Target domain:** jaharoni.com / justinaharoni.com

---

## Vision

This is not a photography portfolio. It is a **creative director's immersive studio** � a living, breathing portal to photography, video, AI-generated media, and application development. The site is the public proof of Creative Liberation Engine's capability, orchestrated by Artist.
...
- [ ] CORS configured for jaharoni.com domain only
- [ ] CSP headers configured in vercel.json

### Domain & DNS
- [ ] jaharoni.com DNS pointed to Vercel (when ready)
...
- **GitHub repo:** WholeTroutMedia/justin-aharoni-photography
...
|------|-------|-----------|-------|
| 1 | Seed content: upload 30-50 pieces to Firebase Storage via admin | Access to NAS/D: | Artist + NAVD |
...
| 6 | Sound design: ambient audio layer | Step 4 | Artist (creative direction) |
...
| 10 | DNS: point jaharoni.com to Vercel | Step 9 | Artist |
| 11 | Cancel SquareSpace | Step 10 confirmed | Artist |
...
- The front door to everything Sovereign Artist creates
