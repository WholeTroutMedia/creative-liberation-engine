# Sovereign Infrastructure Policy â€” creative-liberation-engine-v5 GENESIS
...
1. **Synology NAS** (`\\wholetroutmedia` / `127.0.0.1`) â€” primary deploy target
...
- Repository: `http://127.0.0.1:3000/WholeTroutMedia/`
