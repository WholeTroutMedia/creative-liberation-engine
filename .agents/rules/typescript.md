# TypeScript Standards — creative-liberation-engine-v5 GENESIS
...
- Import from `@cle/[package]`, not relative paths across packages

## v5 Package Conventions

- All packages under `packages/` use `@cle/` scope
