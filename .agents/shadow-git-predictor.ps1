#!/usr/bin/env pwsh
# shadow-git-predictor.ps1 Ã¢â‚¬â€ Semantic Git Diff Prediction
# Polls uncommitted changes. Offloads to Cloud Run / Genkit for predicting next block.

$log = Join-Path $PSScriptRoot "shadow-git-predictor.log"
$v5 = Split-Path $PSScriptRoot -Parent
$shadowDir = Join-Path $PSScriptRoot "shadow-diffs"
