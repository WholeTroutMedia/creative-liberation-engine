...
# /comet-boot â€” Lightweight COMET Boot Protocol
...
```
âš¡ COMET BOOT â€” GENESIS v5
Dispatch: âœ… online   Queue: N tasks
AVERI: ATHENA âœ… VERA âœ… IRIS âœ… (registered on mesh)
Boot time: <3s
```
