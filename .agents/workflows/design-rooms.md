---
description: trigger the Rooms.xyz digital storefront pipeline Ã¢â‚¬â€ WorldGen prompt Ã¢â€ â€™ voxel placement Ã¢â€ â€™ Lua Stripe commerce injection
---
...
```
Prompt Ã¢â€ â€™ WorldGen API (Gemini parser) Ã¢â€ â€™ Queue Ã¢â€ â€™ nexus-bridge polls Ã¢â€ â€™
Playwright opens Rooms.xyz Ã¢â€ â€™ Voxels placed Ã¢â€ â€™ Lua Stripe hook injected
```
...
```powershell
cd Y:\\creative-liberation-engine\packages\zero-day
npm run dev
```
...
```powershell
cd Y:\\creative-liberation-engine\services\nexus-bridge
...
- **nexus-bridge not placing blocks**: Rooms.xyz UI may have changed Ã¢â‚¬â€ check Playwright selector targeting in `services/nexus-bridge/src/index.ts`
