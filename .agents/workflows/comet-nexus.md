...
Activates the NEXUS Bridge Ã¢â‚¬â€ a Playwright daemon that physically logs into Rooms.xyz on the workstation, connects to the configured Creative Liberation Engine Room, and pipes dispatch board telemetry straight into the environment.
