---
description: Deploy any WholeTroutMedia service to NAS Docker Ã¢â‚¬â€ ALWAYS via Gitea CI/CD. Never SSH. Never manual PowerShell.
---
...
- **Actions**: `http://127.0.0.1:3000/WholeTroutMedia/creative-liberation-engine/actions`
...
Invoke-RestMethod "http://127.0.0.1:3000/api/v1/repos/WholeTroutMedia/creative-liberation-engine/actions/workflows/deploy-genesis.yml/dispatches" -Method Post -Headers $headers -Body '{"ref":"main"}'
```
...
Invoke-RestMethod "http://127.0.0.1:3000/api/v1/repos/WholeTroutMedia/creative-liberation-engine/actions/tasks?limit=3" -Headers $headers | ConvertTo-Json -Depth 3
```
