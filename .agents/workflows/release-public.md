...
1. Navigate to the creative-liberation-engine root:

```powershell
cd "Y:\\creative-liberation-engine"
```

2. Dry run first Ã¢â‚¬â€ verify what will be exported and scrubbed:
...
4. Full release Ã¢â‚¬â€ move to released, bump version, export, push:
