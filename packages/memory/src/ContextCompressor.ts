import { okResult, errResult, type Result } from '@cle/core';
...
export class ContextCompressor {
     ...
     */
    public async compressObservation(rawInput: string, strategy: 'dom' | 'terminal'): Promise<Result<string, string>> {
        try {
