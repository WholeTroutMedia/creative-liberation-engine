...
import { scoreDesign, formatReport, type QualityReport } from '@cle/design-agent';
...
export const GenerateUIInput = z.object({
    ...
    componentScope: z.array(z.string()).optional().describe('Limit to specific components from @cle/ui'),
...
export const UIVariation = z.object({
    ...
    jsx: z.string().describe('JSX code using only @cle/ui components and token CSS vars'),
...
2. NEVER create a new component. Only use components from @cle/ui:
