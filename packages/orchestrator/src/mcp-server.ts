...
import { ALFRED_AGENT_CARD, CLE_ORCHESTRATOR_CARD } from '../../mcp-router/src/a2a-protocol.js';

const server = new Server(
  { name: 'cle-orchestrator', version: '5.0.0' },
  { capabilities: { tools: {} } }
);
  ...
  switch (name) {
    ...
    case 'discovery.get_agent_card': {
        ...
        switch (target.toUpperCase()) {
            ...
            case 'ORCHESTRATOR': card = CLE_ORCHESTRATOR_CARD; break;
