...
const MARKDOWN_QUEUE = path.resolve(__dirname, '../../../../.agents/dispatch/task-queue.md');
export async function migrateFromMarkdown() {
    ...
    for (const row of tableRows) {
        ...
        const task = {
            ...
            status: (status === 'active' ? 'queued' : 'queued'), // reset all to queued
            dependencies: [],
            parent_task_id: null,
            spawned_by: null,
