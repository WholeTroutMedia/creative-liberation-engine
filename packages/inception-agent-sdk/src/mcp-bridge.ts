/**
 * CLE Agent SDK — MCP Bridge
 *
 * Wraps CLEAgentClient with MCP (Model Context Protocol) framing.
...
export class McpBridge {
  ...
  constructor(manifest: AgentManifest) {
    ...
    this.client = new CLEAgentClient(manifest);
  }
