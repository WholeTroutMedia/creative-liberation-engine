/**
 * cle-agent-sdk client tests
 * @package cle-agent-sdk
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';
import { CLEAgentClient } from '../client.js';
...
describe('CLEAgentClient — Registration', () => {
  ...
  it('POSTs correct registration payload to dispatch', async () => {
    ...
    const client = new CLEAgentClient(testManifest);
...
describe('CLEAgentClient — Heartbeat', () => {
  afterEach((): void => { vi.restoreAllMocks(); });
...
describe('CLEAgentClient — Task Handling', () => {
  afterEach((): void => { vi.restoreAllMocks(); });
...
describe('CLEAgentClient — Completion', () => {
  afterEach((): void => { vi.restoreAllMocks(); });
