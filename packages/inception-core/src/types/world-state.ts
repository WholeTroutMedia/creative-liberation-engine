...
export interface EngineWorldState {
  ...
  /**
   * Agent orchestration and multi-day checkpoint states.
   * Enables deep sleep and persistence to the NAS.
   */
  orchestration: {
    status: 'RUNNING' | 'HIBERNATING' | 'COMPLETED' | 'FAILED';
    activeCheckpoints: Record<string, {
      resumeToken: string;
