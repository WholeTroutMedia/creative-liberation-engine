        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    adminEmail = (_a = getEnv('ADMIN_EMAIL')) !== null && _a !== void 0 ? _a : 'inquiries@creativeliberationengine.org';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    body = "".concat(SEVERITY_EMOJI[alert.severity], " [CLE/").concat(alert.severity.toUpperCase(), "] ").concat(alert.title, "\n").concat(alert.body.slice(0, 140));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
