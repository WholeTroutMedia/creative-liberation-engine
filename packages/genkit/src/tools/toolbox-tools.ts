...
export const imageCompressTool = ai.defineTool(
    ...
    async (input: { originalBytes: number, targetFormat: "jpeg" | "webp" | "avif" | "png", quality: number }) => {
...
export const jsonPrettyTool = ai.defineTool(
    ...
    async (input: { json: string, indent: number }) => {
...
export const csvParseTool = ai.defineTool(
    ...
    async (input: { csv: string, delimiter: string }) => {
...
export const contrastRatioTool = ai.defineTool(
    ...
    async (input: { hex1: string, hex2: string }) => {
...
export const base64EncodeTool = ai.defineTool(
    ...
    async (input: { input: string, urlSafe: boolean }) => {
...
export const slugifyTool = ai.defineTool(
    ...
    async (input: { input: string, separator: string, maxLength?: number }) => {
...
export const generateSecretTool = ai.defineTool(
    ...
    async (input: { length: number, charset: "alphanumeric" | "hex" | "base64url" | "numeric" | "symbols" }) => {
