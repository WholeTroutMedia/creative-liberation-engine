        ...
        try {
            ...
            parsed = {
                ...
                serverRoute: {
                    ...
                    handlerSnippet: `app.post('/api/${derivedFlowName}', async (req, res) => { try { const result = await ${derivedFlowName}(req.body); res.json(result); } catch (e: any) { res.status(500).json({ error: e.message }); } });`,
                },
