...
import { ZigSimBridge, type ZigSimBridgeConfig } from './ZigSimBridge.js';
...
export type {
    HumanStateContext,
    BiometricConsentMode,
} from './HumanStateContext.js';

export {
    getHumanStateContext,
    invalidateBiometricCache,
    isBiometricBridgeOnline,
} from './human-state-bridge.js';
