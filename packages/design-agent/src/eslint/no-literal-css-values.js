...
// Usage: add "cle/no-literal-css-values": "error" to .eslintrc
...
module.exports = {
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Disallow literal CSS values in JSX — use CLE design tokens instead',
            category: 'Design System',
            recommended: true,
            url: 'https://github.com/wholeTrout/creative-liberation-engine-v5/tree/main/packages/design-agent#eslint-rule',
        },
        fixable: null,
        schema: [
            {
