/**
 * @cle/mcp-router â€” Fetch Proxy Tool
...
export const fetchProxyTool = {
  ...
  description:
    'Proxy an HTTP request through the CLE_CORE gateway â€” resolves COMET browser API restrictions. ' +
