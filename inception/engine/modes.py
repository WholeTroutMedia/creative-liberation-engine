...
MODE_CONFIGS: dict[ModeType, ModeConfig] = {
    ModeType.IDEATE: ModeConfig(
        ...
        allowed_hives=["LEXICON", "HERALD", "kuid"],
    ...
    ModeType.PLAN: ModeConfig(
        ...
        allowed_hives=["kuid", "ALCHEMY", "LEXICON"],
        default_agents=["NEXUS", "kbuildd", "kstored"],
        parallel_limit=3,
    ),
    ...
    ModeType.VALIDATE: ModeConfig(
        ...
        allowed_hives=["kuid", "ALCHEMY"],
        default_agents=["LENS", "kstored"],
        parallel_limit=2,
    ),
}
