...
class EngineConfig:
    ...
    github_token: str = ""
    github_memory_repo: str = "Creative-Liberation-Engine/inception-memory"
...
def load_config(env_file: Optional[str] = None) -> EngineConfig:
    ...
    _config = EngineConfig(
        ...
        github_memory_repo=os.getenv("GITHUB_MEMORY_REPO", "Creative-Liberation-Engine/inception-memory"),
