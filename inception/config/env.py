...
class EngineConfig:
    ...
    github_token: str = ""
    github_memory_repo: str = "WholeTroutMedia/cle-memory"
...
def load_config(env_file: Optional[str] = None) -> EngineConfig:
    ...
    _config = EngineConfig(
        ...
        default_model=os.getenv("CLE_DEFAULT_MODEL", "gemini-2.0-flash"),
        chroma_host=os.getenv("CHROMA_HOST", "localhost"),
        chroma_port=int(os.getenv("CHROMA_PORT", "8000")),
        github_token=os.getenv("GITHUB_TOKEN", ""),
        github_memory_repo=os.getenv("GITHUB_MEMORY_REPO", "WholeTroutMedia/cle-memory"),
        firebase_project_id=os.getenv("FIREBASE_PROJECT_ID", ""),
        firebase_service_account_path=os.getenv("FIREBASE_SERVICE_ACCOUNT_PATH", ""),
        access_tier=os.getenv("CLE_ACCESS_TIER", "studio"),
        host=os.getenv("CLE_HOST", "0.0.0.0"),
        port=int(os.getenv("CLE_PORT", "8080")),
        debug=os.getenv("CLE_DEBUG", "true").lower() == "true",
        root_dir=Path.cwd(),
    )
