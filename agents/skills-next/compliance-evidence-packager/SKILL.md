...
description: "Compliance Evidence Packager skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade compliance evidence packager capability for V6 operations.
