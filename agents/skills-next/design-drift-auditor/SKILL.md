...
description: "Design Drift Auditor skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade design drift auditor capability for V6 operations.
