...
description: "Attack Surface Mapper skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade attack surface mapper capability for V6 operations.
