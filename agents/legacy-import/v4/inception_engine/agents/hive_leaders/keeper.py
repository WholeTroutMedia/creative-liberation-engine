...
class KEEPERAgent(BaseAgent):
    ...
    def execute(self, context: Dict[str, Any]) -> AgentResult:
        ...
        if task_type == "organize_knowledge":
            return AgentResult(success=True, output=self._organize_knowledge(task, context))
        elif task_type == "documentation":
            return AgentResult(success=True, output=self._create_documentation(task, context))
        elif task_type == "knowledge_graph":
            return AgentResult(success=True, output=self._build_knowledge_graph(task, context))
        else:
            return AgentResult(success=True, output=self._general_knowledge_management(task, context))
    ...
    def _general_knowledge_management(
        self, task: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
