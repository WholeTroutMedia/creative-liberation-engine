...
2. Run the ingest script:
   ...
   ```powershell
   npx tsx "D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine\packages\design-agent\src\ingestion\framer.ts" "<url>" "D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine\apps\console\src\components\framer"
   ```
