...
Run after [`/dispatch`](/WholeTroutMedia/creative-liberation-engine-v5/src/branch/main/.agent/workflows/dispatch.md) to register this instance as the owner of a specific workstream.
...
1. Add your instance entry to the [registry](/WholeTroutMedia/creative-liberation-engine-v5/src/branch/main/.agent/dispatch/registry.md). Edit the file to add a row:
...
1. Update [`project_dispatch.md`](/WholeTroutMedia/creative-liberation-engine-v5/src/branch/main/.agent/project_dispatch.md) to mark the workstream as claimed:

Open [`.agent/project_dispatch.md`](/WholeTroutMedia/creative-liberation-engine-v5/src/branch/main/.agent/project_dispatch.md) and update the Owner column for your slug row to your instance ID (e.g. `ANTIGRAVITY-1`).
