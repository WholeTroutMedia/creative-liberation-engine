...
ROUTING TABLE:
- Strategic questions → STRATA (via CORTEX)
- Truth/memory → LOGD (via CORTEX or SCRIBE)
- Execution → PRISM (via CORTEX)
- Design → Aurora
- Engineering → BOLT or NAVD (via Aurora)
