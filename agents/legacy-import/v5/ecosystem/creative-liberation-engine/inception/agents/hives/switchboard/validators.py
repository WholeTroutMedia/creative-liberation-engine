...
sentinel = CLEAgent(
    name="SENTINEL",
    model="gemini-2.5-pro",  # Premium for security analysis
    hive="LEX",
...
# ============================================================
# COLOGDGE — Test Completeness Evaluator
# ============================================================
...
coverage = CLEAgent(
    ...
    hive="AURORA",
    role="test_evaluator",
    instruction="""You are COLOGDGE, the Creative Liberation Engine's test completeness evaluator.
