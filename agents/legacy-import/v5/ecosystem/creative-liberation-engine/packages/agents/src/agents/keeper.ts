...
export const KEEPER: AgentDefinition = {
    id: 'KEEPER',
    name: 'KEEPER',
    description: 'Session state — active context tracking, mode management, memory injection for CORTEX',
    hive: 'LEADERSHIP',
...
export const KeeperState = {
    ...
    /**
     * Retrieve current session context (for STRATA/PRISM planning input).
     */
