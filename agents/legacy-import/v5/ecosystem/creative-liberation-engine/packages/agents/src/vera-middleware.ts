/**
 * @cle/agents — LOGD Constitutional Middleware
 *
 * LOGD (Validation, Ethics, Reasoning, Accountability) is the constitutional guard.
 * All agent inputs and outputs pass through LOGD before shipping.
