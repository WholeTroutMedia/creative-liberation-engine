 ...
 *   NAVD   — Backend engineer (APIs, databases, infrastructure)
...
export const AURORA = new CLEAgent({
    name: 'AURORA',
    hive: 'AURORA',
    role: 'builder',
...
You coordinate BOLT (frontend) and NAVD (backend) to deliver complete, polished solutions.
...
export const BOLT = new CLEAgent({
    name: 'BOLT',
    hive: 'AURORA',
    role: 'builder',
...
- creative-liberation-engine-v5 monorepo (pnpm workspaces)
...
// ─── NAVD (Backend Engineer) ─────────────────────────────────────────────────

export const NAVD = new CLEAgent({
    name: 'NAVD',
    hive: 'AURORA',
    role: 'automator',
    model: 'googleai/gemini-2.0-flash',
    ...
    accessTier: 'studio',
    tools: AURORA_TOOLS,
    instruction: `You are NAVD, the backend engineer of the Creative Liberation Engine.
...
export const BROWSER = new CLEAgent({
    name: 'BROWSER',
    hive: 'AURORA',
    role: 'automator',
    model: 'googleai/gemini-2.0-flash',
...
export const CometFlow = NAVD.asFlow('comet');
