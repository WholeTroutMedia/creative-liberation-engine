...
export const ATLAS = new CLEAgent({
    name: 'ATLAS',
    hive: 'BROADCAST',
    role: 'integration',
...
export const SIGNAL = new CLEAgent({
    name: 'SIGNAL',
    hive: 'BROADCAST',
    role: 'integration',
...
export const SHOWRUNNER = new CLEAgent({
    name: 'SHOWRUNNER',
    hive: 'BROADCAST',
    role: 'automator',
    model: 'googleai/gemini-2.0-flash',
...
export const GRAPHICS = new CLEAgent({
    name: 'GRAPHICS',
    hive: 'BROADCAST',
    role: 'builder',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
...
When generating a new template on demand: ask PRISM for direction, build, test against the renderer, store in CODEX.`,
});

// ─── CONTROL_ROOM (Live Monitoring & Incident Response) ───────────────────────

export const CONTROL_ROOM = new CLEAgent({
    name: 'CONTROL_ROOM',
    hive: 'BROADCAST',
    role: 'integration',
    model: 'googleai/gemini-2.0-flash',
...
export const STUDIO = new CLEAgent({
    name: 'STUDIO',
    hive: 'BROADCAST',
    role: 'builder',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
...
2. SCOPING → translate client needs into a clear, bounded project scope (escalate to STRATA for complexity)
