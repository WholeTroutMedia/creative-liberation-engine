...
export const KEEPER = new CLEAgent({
    name: 'KEEPER',
    hive: 'KEEPER',
    role: 'knowledge',
...
export const ARCH = new CLEAgent({
    name: 'ARCH',
    hive: 'KEEPER',
    role: 'knowledge',
...
export const CODEX = new CLEAgent({
    name: 'CODEX',
    hive: 'KEEPER',
    role: 'knowledge',
    model: 'googleai/gemini-2.0-flash',
...
export const ECHO = new CLEAgent({
    name: 'ECHO',
    hive: 'KEEPER',
    role: 'knowledge',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
...
export const SCRIBE = new CLEAgent({
    name: 'SCRIBE',
    hive: 'KEEPER',
    role: 'knowledge',
    model: 'googleai/gemini-2.0-flash',
...
export const COMMERCE = new CLEAgent({
    name: 'COMMERCE',
    hive: 'KEEPER',
    role: 'builder',
    model: 'googleai/gemini-2.0-flash',
...
5. REVENUE REPORTING — weekly MRR, ARR, churn, expansion revenue report to STRATA
