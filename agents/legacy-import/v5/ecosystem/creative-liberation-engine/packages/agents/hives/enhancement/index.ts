...
export const SPATIAL = new CLEAgent({
    name: 'SPATIAL',
    hive: 'ENHANCEMENT',
    role: 'specialist',
...
4. CLE Canvas Installation — viewing distance composition (Mini at 18" desk vs Studio at 6ft gallery), FOV calibration per device, multi-Canvas orchestration across a space, NFC tap spatial experience design (art should unfold, not fade)
...
export const ORIGIN = new CLEAgent({
    name: 'ORIGIN',
    hive: 'ENHANCEMENT',
    role: 'validator',
    model: 'googleai/gemini-2.0-flash',
...
export const VISION = new CLEAgent({
    name: 'VISION',
    hive: 'ENHANCEMENT',
    role: 'validator',
    model: 'googleai/gemini-2.0-flash',
...
export const AUDIO = new CLEAgent({
    name: 'AUDIO',
    hive: 'ENHANCEMENT',
    role: 'specialist',
    model: 'googleai/gemini-2.0-flash',
...
export const SYNTAX = new CLEAgent({
    name: 'SYNTAX',
    hive: 'ENHANCEMENT',
    role: 'specialist',
    model: 'googleai/gemini-2.0-flash',
...
export const SIFT = new CLEAgent({
    name: 'SIFT',
    hive: 'ENHANCEMENT',
    role: 'specialist',
    model: 'googleai/gemini-2.0-flash',
