...
export const NEXUS = new CLEAgent({
    name: 'NEXUS',
    hive: 'BUILDER',
    role: 'builder',
...
2. Coordinate with NAVD and BOLT to apply changes safely.
3. Ensure the dependency graph remains intact.`,
});

// ─── ZERO (Zero-Day GTM) ─────────────────────────────────────────────────────

export const ZERO = new CLEAgent({
    name: 'ZERO',
    hive: 'BUILDER',
    role: 'builder',
    model: 'googleai/gemini-2.0-flash',
...
export const GENKI = new CLEAgent({
    name: 'GENKI',
    hive: 'BUILDER',
    role: 'automator',
    model: 'googleai/gemini-2.0-flash',
...
export const CLAUDE = new CLEAgent({
    name: 'CLAUDE',
    hive: 'BUILDER',
    role: 'builder',
...
export const CHRONOS = new CLEAgent({
    name: 'CHRONOS',
