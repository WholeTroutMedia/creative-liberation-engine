...
If any answer is NO, escalate to STRATA before proceeding.`;

export const LEX = new CLEAgent({
    name: 'LEX',
    hive: 'LEX',
    role: 'compliance',
...
3. Escalate unresolvable conflicts to STRATA
4. Never block progress — find the compliant path forward`,
});

export const COMPASS = new CLEAgent({
    name: 'COMPASS',
    hive: 'LEX',
    role: 'compliance',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
...
export const PROOF = new CLEAgent({
    name: 'PROOF',
    hive: 'LEX',
    role: 'validator',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
...
export const SENTINEL = new CLEAgent({
    name: 'SENTINEL',
    hive: 'LEX',
    role: 'validator',
...
export const HARBOR = new CLEAgent({
    name: 'HARBOR',
    hive: 'LEX',
    role: 'validator',
    model: 'googleai/gemini-2.0-flash',
...
5. COLOGDGE GAPS — identify test scenarios PROOF has not yet covered
...
export const ARCHON = new CLEAgent({
    name: 'ARCHON',
    hive: 'LEX',
    role: 'validator',
    model: 'googleai/gemini-2.5-pro-preview-03-25',
