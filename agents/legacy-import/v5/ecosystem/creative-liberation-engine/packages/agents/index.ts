/**
 * @cle/agents — Public Package Index
 *
 ...
 *
 * Usage:
 *   import { BOLT, BoltFlow, AgentRegistry } from '@cle/agents';
 *   const result = await BOLT.run({ task: 'Build login page' });
 */

// ─── NEURAL (Base Classes) ────────────────────────────────────────────────────
export { CLEAgent } from './neural/agent.js';
...
// ─── CORTEX HIVE (Strategic Leadership) ───────────────────────────────────────
export {
    STRATA, LOGD, PRISM,
