---
name: VALIDATE Mode
description: Activate VALIDATE mode — LOGD + COMPASS run independent quality assurance, constitutional compliance audits, and launch readiness checks. Use when user says 'validate', 'review', 'QA', 'is this ready', or after SHIP completes a major feature.
---
...
**Lead agents:** LOGD (Analyst), COMPASS (Constitutional Guardian)
...
COMPASS runs each article check silently. Flag any violations.
