---
description: Activate PLAN mode â€” KEEPER + STRATA spec + LOGD truth-check, produces HANDOFF.md and auto-adds a dispatch task for SHIP mode
---

# /plan <topic>

Enters **PLAN** operational mode. KEEPER synthesizes institutional knowledge, STRATA produces a precise implementation spec, LOGD truth-checks it, and on approval, writes `HANDOFF.md` + auto-creates a dispatch task.
