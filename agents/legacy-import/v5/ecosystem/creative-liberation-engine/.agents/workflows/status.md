...
// turbo
3. Read `../creative-liberation-engine-v4/CORE_FOUNDATION/system-status.json` for CORTEX health.
...
// turbo
2. Read `../creative-liberation-engine-v4/CORE_FOUNDATION/system-status.json`
