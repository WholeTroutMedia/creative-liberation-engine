...
1. **Offer release pipeline:**
    ...
    Ready to:
    1. `/validate` â€” LOGD + COMPASS full quality gate (recommended)
...
| Blocker | Action |
|---------|--------|
| Missing type from another package | Add to `cle-core` first |
...
- Support: LOGD (Quality gate), COMPASS (Constitutional review)
