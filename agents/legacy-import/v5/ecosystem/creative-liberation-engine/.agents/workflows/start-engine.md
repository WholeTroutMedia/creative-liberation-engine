...
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
â•‘  CORTEX FLOWS                                         â•‘
â•‘    POST /averi/ideate   â€” IDEATE mode (KEEPER+STRATA)â•‘
â•‘    POST /averi/plan     â€” PLAN mode  (KEEPER+STRATA+LOGD) â•‘
...
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
â•‘  NEXT STEPS                                          â•‘
â•‘    /averi-ideate <topic>  â€” Run IDEATE mode live     â•‘
â•‘    /browser-ideate        â€” Tab context â†’ IDEATE     â•‘
â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
```

Optionally do a quick smoke-test of `/averi/ideate` with `{ "topic": "ping", "depth": "light" }` to confirm CORTEX flows are wired. Report result inline.
