"""
Platform Adapters - Creative Liberation Engine, Perplexity, Generic
...
class Creative Liberation EngineAdapter(PlatformAdapter):
  """Creative Liberation Engine IDE adapter - model switch commands for editor sessions."""

  def format_response(self, classification, selection) -> Dict:
    return {
      "platform": "cle", "action": "model_switch",
...
def get_adapter(platform: str = "generic", strategy: str = "balanced") -> PlatformAdapter:
  ...
  adapters = {
    "cle": Creative Liberation EngineAdapter,
