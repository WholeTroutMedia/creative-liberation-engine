"""
Creative Liberation Engine v5 — CLEAgent Base Class
...
# Article VI: Never hardcode a model string — read from env at import time.
_DEFAULT_MODEL = (
    os.environ.get("CLE_DEFAULT_MODEL")
    or os.environ.get("GENKIT_DEFAULT_MODEL")
    or "googleai/gemini-2.0-flash"  # last-resort sentinel — set CLE_DEFAULT_MODEL in .env
)
...
class CLEAgent:
    ...
    def __repr__(self) -> str:
        ...
        return f"<CLEAgent {self.name} hive={self.hive} model={self.model} tools={tools}>"
