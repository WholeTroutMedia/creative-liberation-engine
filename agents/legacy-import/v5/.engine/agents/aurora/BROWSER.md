...
BROWSER is the computer-use and web orchestration specialist of Hive LUMIND. Operating through the Chrome DevTools Protocol (CDP), BROWSER enables the Creative Liberation Engine to control, automate, and extract intelligence from web browsers — enabling AI-driven workflows that span the open web.
