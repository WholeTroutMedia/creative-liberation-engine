...
description: "Prompt Regression Guard skill for model agent quality operations in Creative Liberation Engine V6."
agentCallable: true
---
...
Provide a production-grade prompt regression guard capability for the model agent quality family.
