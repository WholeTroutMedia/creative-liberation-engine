...
description: "Incident Forensics skill for security operations in Creative Liberation Engine V6."
agentCallable: true
---
...
Provide a production-grade incident forensics capability for the security family.
