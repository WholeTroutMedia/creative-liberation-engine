...
description: "Multi Model Consensus skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade multi model consensus capability for V6 operations.
