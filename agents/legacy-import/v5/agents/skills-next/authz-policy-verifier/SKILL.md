---
name: "authz-policy-verifier"
description: "Authz Policy Verifier skill for security operations in Creative Liberation Engine V6."
agentCallable: true
---

# Authz Policy Verifier

## Purpose

Provide a production-grade authz policy verifier capability for the security family.
