---
name: "governance-exception-tracker"
description: "Governance Exception Tracker skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---

# Governance Exception Tracker

## Purpose

Provide production-grade governance exception tracker capability for V6 operations.
