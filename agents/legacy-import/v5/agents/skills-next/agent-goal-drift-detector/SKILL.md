---
name: "agent-goal-drift-detector"
description: "Agent Goal Drift Detector skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---

# Agent Goal Drift Detector

## Purpose

Provide production-grade agent goal drift detector capability for V6 operations.
