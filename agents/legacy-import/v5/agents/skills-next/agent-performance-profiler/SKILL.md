...
description: "Agent Performance Profiler skill for model agent quality operations in Creative Liberation Engine V6."
agentCallable: true
---
...
Provide a production-grade agent performance profiler capability for the model agent quality family.
