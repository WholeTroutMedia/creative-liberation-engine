...
description: "Schema Evolution Guard skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade schema evolution guard capability for V6 operations.
