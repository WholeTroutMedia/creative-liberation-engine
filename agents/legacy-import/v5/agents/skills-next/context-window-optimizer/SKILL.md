...
description: "Context Window Optimizer skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---
...
Provide production-grade context window optimizer capability for V6 operations.
