...
description: "Sync Conflict Resolver skill for data integration operations in Creative Liberation Engine V6."
agentCallable: true
---
...
Provide a production-grade sync conflict resolver capability for the data integration family.
