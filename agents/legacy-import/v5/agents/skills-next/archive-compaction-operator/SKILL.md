---
name: "archive-compaction-operator"
description: "Archive Compaction Operator skill for Creative Liberation Engine V6 batch 2."
agentCallable: true
---

# Archive Compaction Operator

## Purpose

Provide production-grade archive compaction operator capability for V6 operations.
