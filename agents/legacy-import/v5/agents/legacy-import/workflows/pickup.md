---
description: Pick up the next available task from the CLE Dispatch Server â€” no workspace, no slash commands, no configuration needed
---
...
// turbo
5. Run `git -C "D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine" pull origin main --rebase` silently.
...
- Project root is always `D:\Google Antigravity\Infusion Engine Brainchild\creative-liberation-engine-v5` â€” never ask the user for it
