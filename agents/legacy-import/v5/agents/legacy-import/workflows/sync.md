...
1. Run `git -C "D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine" status` to check for any uncommitted local changes.

// turbo
2. Run `git -C "D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine" pull origin main --rebase` to pull latest.
