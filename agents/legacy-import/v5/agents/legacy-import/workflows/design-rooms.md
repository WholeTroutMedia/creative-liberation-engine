...
```powershell
cd D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine\packages\zero-day
npm run dev
```
...
```powershell
cd D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine\services\nexus-bridge
