...
# Quick nav (v5 repo only — no creative-liberation-engine-v4)
function bc5 { Set-Location "D:\Google Antigravity\Infusion Engine Brainchild\creative-liberation-engine-v5" }
```
...
{
  "name": "creative-liberation-engine-v5",
  "commandline": "powershell.exe -NoExit -Command \"Set-Location 'D:\Google Antigravity\Infusion Engine Brainchild\\creative-liberation-engine-v5'\"",
  "icon": "âš¡",
...
- [ ] Windows Terminal has `NAS Shell` and `creative-liberation-engine-v5` profiles
