...
| **KI (Knowledge Item)** | "What we know" — distilled, long-term reference | Creative Liberation Engine KI system (see `docs/MEMORY_CONTRACT.md` — postcard vs newspaper) |
...
Get-ChildItem "D:\Google Antigravity\Infusion Engine Brainchild\creative-liberation-engine-v5\packages\memory\scribe_archive\" -Recurse -Filter "*.md" | Select-String "<query>"
```
...
```powershell
# Semantic memories
$path = "D:\Google Antigravity\Infusion Engine Brainchild\creative-liberation-engine-v5\packages\memory\scribe_archive\semantic\"

# Episodic memories
$path = "D:\Google Antigravity\Infusion Engine Brainchild\creative-liberation-engine-v5\packages\memory\scribe_archive\episodic\"
```
