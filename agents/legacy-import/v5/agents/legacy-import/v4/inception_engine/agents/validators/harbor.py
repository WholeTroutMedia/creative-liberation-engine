...
class HARBORAgent(BaseAgent):
    ...
    def _validate_unit_tests(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": ["Excellent unit test coverage", "All critical paths tested"],
        }
    ...
    def _validate_integration_tests(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": ["Strong integration test coverage", "API contracts validated"],
        }
    ...
    def _validate_e2e_tests(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": ["Critical user journeys tested", "Happy and unhappy paths covered"],
        }
    ...
    def _analyze_coverage(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "recommendations": ["Coverage exceeds 70% threshold", "All critical code paths tested"],
        }
    ...
    def _calculate_coverage_score(self, validation_results: Dict[str, Any]) -> int:
        ...
        return int(
            (metrics["line_coverage"] + metrics["branch_coverage"] + metrics["function_coverage"])
            / 3
        )
