...
description: Activates SCRIBE mode for writing memories to ChromaDB/NAS — structured memory tagging, episodic vs semantic classification, and cross-session knowledge preservation.
---

# SCRIBE Memory — Creative Liberation Engine Skill
...
2. **Why it matters** (1 sentence — the principle or lesson)
3. **Action implication** (1 sentence — what to do differently or same next time)
...
> "Switched from Docker-in-Docker to socket passthrough for Gitea CI runners — DinD caused iptables exhaustion on the NAS. Socket passthrough is stable. Tag: infra, decision, v5"

**Good semantic memory:**
> "Antigravity reads AGENTS.md automatically at session start — use this file for any project-specific boot instructions. No slash commands needed. Tag: antigravity, pattern, v5"

## NAS ChromaDB Endpoint

- Host: `127.0.0.1:8000`
- Collection: `cle_engine_memory`
