...
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var server, tools, expectedTools, _i, expectedTools_1, tool;
        return __generator(this, function (_a) {
            ...
            for (_i = 0, expectedTools_1 = expectedTools; _i < expectedTools_1.length; _i++) {
                tool = expectedTools_1[_i];
                if (!tools[tool]) {
                    console.error("FAIL: Tool '".concat(tool, "' was not found in the MCP server registration."));
                    process.exit(1);
                }
                console.log("SUCCESS: Tool '".concat(tool, "' is registered successfully."));
            }
