...
async function login() {
    ...
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step0_flow_loaded.png' });

    const email = 'inquiries@creativeliberationengine.org';
    const password = 'WholeTroutMedia!2026';
    const username = 'CLEEngine';
    ...
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step1_typed_email.png' });
    ...
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step2_after_next.png' });
    ...
    if (suspiciousExists) {
        ...
        await page.keyboard.press('Enter');
        await new Promise(r => setTimeout(r, 4000));
        await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step2.5_verification.png' });
    }
    ...
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step3_typed_password.png' });
    ...
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_step4_final.png' });
