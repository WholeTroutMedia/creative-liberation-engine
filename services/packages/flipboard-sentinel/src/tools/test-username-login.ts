...
async function test() {
    ...
    console.log(`[LOGIN_TEST] Typing username: CLEEngine`);
    await page.type(usernameSelector, 'CLEEngine', { delay: 100 });
    await new Promise(r => setTimeout(r, 1000));
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_test_username_entered.png' });
    ...
    await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_test_after_username.png' });
