...
async function solve() {
    ...
    if (isLimitedOnStart) {
        ...
        await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_end.png' });
        await browser.disconnect();
    ...
    if (loggedIn) {
        ...
        await page.screenshot({ path: '/app/creative-liberation-engine/runtime/x_login_success.png' });
        await browser.disconnect();
        process.exit(0);
    } else {
