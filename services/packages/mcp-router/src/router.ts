 ...
 *            (e.g., @cle/genkit). Avoids hard dep on genkit here.
 *
...
/**
 * Inject a LLM classifier from the host environment (e.g. @cle/genkit).
 * If not injected, Stage 2 returns an empty result and the router falls back to 'general'.
 *
 * Call once during app initialization:
 * ```ts
 * import { setLLMClassifier } from '@cle/mcp-router';
