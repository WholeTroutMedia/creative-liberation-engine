...
const server = new Server(
  { name: 'cle-mcp-router', version: '1.0.0' },
  { capabilities: { tools: {} } }
);
  ...
  tools: [
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object',
        properties: {
          tenantId: { type: 'string', description: 'Tenant identifier (e.g. justin-aharoni)' },
...
async function main() {
  ...
  console.error('[MCP-ROUTER] ✅ CLE MCP Router server online');
