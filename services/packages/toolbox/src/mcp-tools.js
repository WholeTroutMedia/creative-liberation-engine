/**
 * TOOL-03: Register @cle/toolbox functions as Genkit tools
...
// — Media ────────────────────────────────────────────────────────────
import { getVideoFormatInfo, estimateImageCompression, optimizeSVG, parseAudioDuration, formatDuration, } from './categories/media.js';
// ── Data ─────────────────────────────────────────────────────────────────────
import { jsonPretty, csvParse, markdownToHtml, } from './categories/data.js';
// — Dev ──────────────────────────────────────────────────────────────
import { generateUUID, hashFNV32, regexTest, jwtDecode, } from './categories/dev.js';
// ── Design ───────────────────────────────────────────────────────────────────
import { colorHexToHsl, contrastRatio, paletteGenerator, gradientString, } from './categories/design.js';
// ── Web ───────────────────────────────────────────────────────────────────────
import { urlParse, qrDataEncode, base64Encode, base64Decode, urlSlugify, } from './categories/web.js';
// ── Security ──────────────────────────────────────────────────────────────────
import { passwordStrength, generateSecret, sanitizeHtml, } from './categories/security.js';
// ─────────────────────────────────────────────────────────────────────────────
// MEDIA TOOLS
// ─────────────────────────────────────────────────────────────────────────────
export const videoFormatInfoTool = {
    ...
    fn: ({ extension }) => getVideoFormatInfo(extension) ?? { error: 'Unknown format' },
};
export const imageCompressTool = {
    ...
    fn: ({ originalBytes, targetFormat, quality }) => estimateImageCompression(originalBytes, targetFormat, quality),
};
export const svgOptimizeTool = {
    ...
    fn: ({ svg }) => ({ optimized: optimizeSVG(svg), originalLength: svg.length }),
};
...
export const jsonPrettyTool = {
    ...
    fn: ({ json, indent }) => jsonPretty(json, indent),
};
...
export const hashFnvTool = {
    ...
    fn: ({ input }) => ({ hash: hashFNV32(input), hex: hashFNV32(input).toString(16) }),
};
export const regexTool = {
    ...
    fn: ({ pattern, input, flags }) => regexTest(pattern, input, flags),
};
export const jwtDecodeTool = {
    ...
    fn: ({ token }) => jwtDecode(token) ?? { error: 'Invalid JWT format' },
};
// ─────────────────────────────────────────────────────────────────────────────
// DESIGN TOOLS
// ─────────────────────────────────────────────────────────────────────────────
...
export const contrastRatioTool = {
    ...
    fn: ({ hex1, hex2 }) => contrastRatio(hex1, hex2),
};
...
export const gradientTool = {
    ...
    fn: ({ type, direction, stops }) => ({ gradient: gradientString({ type, direction, stops }) }),
};
// ─────────────────────────────────────────────────────────────────────────────
// WEB TOOLS
// ─────────────────────────────────────────────────────────────────────────────
...
export const qrEncodeTool = {
    ...
    fn: ({ data, errorCorrection }) => qrDataEncode(data, errorCorrection),
};
...
export const slugifyTool = {
    ...
    fn: ({ input, separator, maxLength }) => ({ slug: urlSlugify(input, { separator, maxLength }) }),
};
// ─────────────────────────────────────────────────────────────────────────────
// SECURITY TOOLS
// ─────────────────────────────────────────────────────────────────────────────
export const passwordStrengthTool = {
    ...
    fn: ({ password }) => passwordStrength(password),
};
export const generateSecretTool = {
    ...
    fn: ({ length, charset }) => generateSecret(length, charset),
};
