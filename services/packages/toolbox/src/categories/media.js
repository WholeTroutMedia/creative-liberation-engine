...
export function getVideoFormatInfo(extension) {
 ...
 */
export function estimateImageCompression(originalBytes, targetFormat, quality = 80) {
    const formatBaseRatios = {
        jpeg: 0.1,
        webp: 0.075,
        avif: 0.06,
 ...
 */
export function parseAudioDuration(input) {
    const s = input.trim();
    // HH:MM:SS or MM:SS
