...
const GDRIVE_OAUTH_PATH =
    ...
    'D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine-v5\\.agents\\credentials\\gcp-oauth.keys.json';
const GDRIVE_CREDENTIALS_PATH =
    process.env.GDRIVE_CREDENTIALS_PATH ||
    'D:\\Google Antigravity\\Infusion Engine Brainchild\\creative-liberation-engine-v5\\.agents\\credentials\\.gdrive-server-credentials.json';
