...
import { Ok, Err } from '../../cle-core/src/utils/result.js';
import type { Result } from '../../cle-core/src/utils/result.js';
...
export class CheckpointManager {
    ...
    private readonly stateDir = '\\\\127.0.0.1\\docker\\genesis-deploy\\runtime\\state';
