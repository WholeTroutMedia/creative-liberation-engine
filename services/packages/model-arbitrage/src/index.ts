  ...
  private routePremium(request: RoutingRequest): RoutingDecision {
    return {
      ...
      fallbackChain: [
        ...
        { provider: 'gemini', model: process.env.GENKIT_PRO_MODEL || 'googleai/gemini-2.5-pro' },
      ],
    };
  }
...
export { ModelScorecard, modelScorecard } from './scorecard.js';
// export { BenchmarkRunner } from './benchmark.js';
export { CapabilityRouter } from './capability-router.js';
export { CircuitBreaker } from './circuit-breaker.js';

// ---- Phase D: Cortical Mesh Tier Router (Direction 03) ----
export { MeshRouter, meshRouter } from './mesh-router.js';
export type { MeshTier, MeshProfile, MeshRoutingDecision } from './mesh-router.js';

// ---- Phase E: GPU Hardware Capability Tier (DLSS5 / Blackwell prep) ----
export { GpuTierManager, gpuTierManager } from './gpu-tier.js';
export type { GpuTier, GpuTierCapabilities } from './gpu-tier.js';
