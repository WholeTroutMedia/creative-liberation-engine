        ...
        for i, page in enumerate(pages):
            ...
            if "chat.google.com" in url:
                try:
                    ...
                    await page.screenshot(path=f"/app/data/debug_page_{i}_reloaded.png")
                    print(f"  Saved debug_page_{i}_reloaded.png")
                except Exception as e:
                    print(f"  Failed to reload/screenshot page {i}: {e}")
