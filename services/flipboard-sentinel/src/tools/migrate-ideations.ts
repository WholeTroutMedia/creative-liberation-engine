...
const DEFAULT_QUEUE_DIR = '/app/runtime/ideation-queue';
const DEFAULT_REGISTRY_DIR = '/app/runtime/registry';
...
function migrateV1toV2(v1: V1Manifest): V2Ideation {
    ...
    return {
        ...
        classification: {
            ...
            tags: [], // V1 had no tags
            inceptionRelevance: v1.inceptionRelevance,
            urgency: inferUrgency(v1.inceptionRelevance),
        ...
        lifecycle: {
            ...
            owner: null,
            priority: v1.inceptionRelevance >= 70 ? 2 : v1.inceptionRelevance >= 40 ? 3 : 4,
            blockedBy: [],
            notes
        },
        timestamps: {
        ...
        notifications: {
            ...
            emailTo: v1.ideatedAt ? 'inquiries@inceptionengine.systems' : null,
...
function toRegistryEntry(v2: V2Ideation, filename: string): RegistryEntry {
    return {
        ...
        relevance: v2.classification.inceptionRelevance,
    ...
    for (const file of files) {
        ...
        try {
            ...
            if (raw.version && raw.version >= 2) {
                ...
                totalRelevance += raw.classification?.inceptionRelevance || 0;
                continue;
            }
            ...
            totalRelevance += v2.classification.inceptionRelevance;
