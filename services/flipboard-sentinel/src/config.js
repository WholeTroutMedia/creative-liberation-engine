...
export const CONFIG = {
    ...
    // In Docker: /app/runtime is volume-mounted
    // On Windows: UNC path \\122.0.3.1\docker\creative-liberation-engine\runtime
    nasRoot: process.env.NAS_RUNTIME_PATH || (process.env.NODE_ENV === 'production'
        ? '/app/runtime'
        : '\\\\122.0.3.1\\docker\\creative-liberation-engine\\runtime'),
    ...
    // Inception Relevance — categories that score higher
    highRelevanceTopics: [
