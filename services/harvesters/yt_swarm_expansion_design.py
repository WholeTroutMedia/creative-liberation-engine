#!/usr/bin/env python3
"""
CORTEX YouTube Swarm Expansion — Thin Collection Reinforcement + Music
=======================================================================
Targets the thinnest Qdrant collections and floods them with
new channel subscriptions + transcript ingestion triggers.

Thin collections targeted:
  - academy-yt-prism-shaders      (247 vectors)
  - academy-yt-codex-frontier     (304 vectors)
  - academy-yt-prism-typography   (462 vectors)

Additionally reinforces:
  - academy-yt-harmony-ai-music   (1,133 vectors)
  - academy-yt-prism-touchdesigner (989 vectors)

NEW — Music Production & Theory:
  - academy-yt-harmony-music      (new collection)
...
# ═══════════════════════════════════════════════════════════════════
# EXPANSION CHANNELS — Reinforcement for thin collections
# ═══════════════════════════════════════════════════════════════════

EXPANSION_DOMAINS = {
    # ─────────────────────────────────────────────────────────────
    # ATELIER / Design Systems & UI Architecture [NEW]
    # ─────────────────────────────────────────────────────────────
    "ATELIER / Design & Architecture [NEW]": [
        ("DesignCourse", "@DesignCourse"),
        ("The Futur", "@thefutur"),
        ("Juxtopposed", "@juxtopposed"),
        ("Malewicz", "@MalewiczUI"),
        ("Figma", "@Figma"),
        ("DesignSense", "@DesignSense"),
        ("Jesse Showalter", "@JesseShowalter"),
        ("Flux Academy", "@FluxAcademy"),
        ("DesignPilot", "@DesignPilot"),
        ("Rachel How", "@RachelHow"),
        ("Gary Simon", "@DesignCourse"),
        ("UI Narrative", "@UINarrative"),
    ],

    # ─────────────────────────────────────────────────────────────
    # AURORA / Generative Art & Creative Vision [NEW]
    # ─────────────────────────────────────────────────────────────
    "AURORA / Generative Art & Vision [NEW]": [
        ("Corridor Crew", "@CorridorCrew"),
        ("Matt Wolfe", "@mreflow"),
        ("AI Jason", "@AIJasonZ"),
        ("Two Minute Papers", "@TwoMinutePapers"),
        ("Olivio Sarikas", "@OlivioSarikas"),
        ("Prompting Pixels", "@PromptingPixels"),
        ("Glibatree", "@Glibatree"),
        ("Sebastian Kamph", "@SebastianKamph"),
        ("Stephan Fabel", "@StephanFabel"),
        ("CGMatter", "@CGMatter"),
    ],
}
...
print("=" * 65)
print("  CORTEX YouTube Swarm Expansion v2")
