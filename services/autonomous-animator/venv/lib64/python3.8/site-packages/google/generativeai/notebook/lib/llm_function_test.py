...
class LLMFunctionBasicTest(absltest.TestCase):
  ...
  def test_run(self):
    ...
    self.assertEqual(
        list(expected_results.keys()), list(results.as_dict().keys())
    )
...
class LLMFunctionPostProcessTest(absltest.TestCase):
  ...
  def test_add_post_process_reorder_fn(self):
    ...
    results = llm_fn.add_post_process_reorder_fn(
        name="reverse_fn", fn=reverse_fn
    )({"word": ["hot"]})
    expected_results = {
        "Prompt Num": [0, 0, 0],
        "Input Num": [0, 0, 0],
  ...
  def test_add_post_process_replace_fn(self):
    ...
    results = llm_fn.add_post_process_replace_fn(
        name="replace_fn", fn=replace_fn
    )({"word": ["hot"]})
    expected_results = {
        "Prompt Num": [0, 0, 0],
        "Input Num": [0, 0, 0],
