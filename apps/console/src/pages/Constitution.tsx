...
const ARTICLES: Article[] = [
    ...
    { id: 11, category: 'Finance', color: CAT_COLORS.Finance, title: 'Article XI — Financial Sovereignty', short: 'kdocsd hive manages financial operations. Stripe integration and contracts fall under constitutional oversight.', full: 'All financial transactions initiated by agents must be operator-authorized through the kdocsd approval workflow. No agent may initiate transactions above operator-set thresholds without explicit escalation.' },
    ...
    { id: 13, category: 'Operations', color: CAT_COLORS.Operations, title: 'Article XIII — Hive Structure', short: 'The Engine is organized into 9 operational hives, each with a lead agent and distinct mandate.', full: 'Hives: kuid (orchestration, kruled), AVERI (creative, ksignd), kstated (memory, kstated-1), SWITCHBOARD (routing, RELAY), kdocsd (legal, kdocsd-1), BROADCAST (media, ATLAS), SPECIALIST (generation, GEN-1), VALIDATOR (QA, GHOST), ENHANCEMENT (optimisation, OPTIMUS).' },
    ...
    { id: 15, category: 'Governance', color: CAT_COLORS.Governance, title: 'Article XV — Amendment Process', short: 'Constitutional amendments require operator review, kruled approval, and a 48-hour cooling period.', full: 'No article may be amended without: (1) operator-initiated request, (2) kruled impact analysis, (3) 48-hour review period, (4) explicit operator sign-off. Emergency amendments require dual-confirmation.' },
