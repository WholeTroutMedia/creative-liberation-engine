...
class AgentRegistry:
    ...
    def __init__(self):
        self._agents: dict[str, CLEAgent] = {}

    def register(self, agent: CLEAgent) -> None:
        """Register an agent."""
